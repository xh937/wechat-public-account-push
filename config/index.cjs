  ...
  USERS: [
    {
      ...
      useTemplateId: 'NDch9fr8B4xCNQvJwkNx0FUMlTQ8P40r7wz5aVsKKMo',
      // 新历生日, 仅用作获取星座运势, 格式必须为MM-DD
      horoscopeDate: '10-27',
      festivals: [
        // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
        {
          type: '*生日', name: '宝贝', year: '2001', date: '10-27',
        },
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {
          type: '生日', name: '李四', year: '2001', date: '10-27',
        },
        {
          type: '节日', name: '相识纪念日', year: '2020', date: '11-01',
        },
      ],
      // 我们在一起已经有xxxx天了的配置
      customizedDateList: [
